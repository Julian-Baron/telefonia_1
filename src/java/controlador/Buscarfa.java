 ...
 * @author lenovo
 */
@WebServlet(name = "Buscarfa", urlPatterns = {"/Buscarfa"})
public class Buscarfa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        /*try (PrintWriter out = response.getWriter()) {
            ...
            if(v){
                JOptionPane.showMessageDialog(null,"datos buscados correctamente");
                response.sendRedirect("RegistroLine.jsp");
            }
            else{
                JOptionPane.showMessageDialog(null,"Datos no buscados");
                response.sendRedirect("RegistroLine.jsp");
                }
            }
        }*/
